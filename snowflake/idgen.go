...
//package comes from https://github.com/sumory/idgen/blob/master/idgen.go
...
func NewIdWorker(workerId int64) (error, *IdWorker) {
	...
	if workerId > maxWorkerId || workerId < 0 {
		return errors.New(fmt.Sprintf("illegal id: %d, it should be greater than 0 and less than %d", workerId, maxWorkerId)), nil
	}
